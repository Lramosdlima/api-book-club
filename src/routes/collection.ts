...
router.get('/owner/:owner_id', middleware.auth, collectionController.getAllByOwnerId); // Coleções que o usuário criou
router.get('/user/:user_id', middleware.auth, collectionController.getAllAddedByUserId); // Coleções que o usuário adicionou
